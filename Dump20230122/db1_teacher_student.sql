...
CREATE TABLE `teacher_student` (
  `id` int NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_STD_ID` FOREIGN KEY (`id`) REFERENCES `students` (`id`),
  CONSTRAINT `teacher_student_ibfk_1` FOREIGN KEY (`id`) REFERENCES `teacher` (`Id`)
...
-- Dump completed on 2023-01-22 15:49:41
